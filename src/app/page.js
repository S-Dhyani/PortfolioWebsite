                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-row justify-around">
                        <div className="bg-[#131315] text-white shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] hover:bg-black hover:text-white rounded-3xl p-4">
                            <Link href="https://github.com/S-Dhyani/"><PiGithubLogoThin size={50} /></Link>
                        </div>
                        <div className="bg-[#131315] text-white shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] hover:bg-[#0a66c2] hover:text-white rounded-3xl p-4">
                            <Link href="https://www.linkedin.com/in/saurabh-dhyani-318268225/" ><PiLinkedinLogoThin size={50} /></Link>
                        </div>
...
My mission? To deliver solutions that are not only functional but also intuitive, proving that the best work often happens under the glow of the moon and a bright monitor.
                    </h1>
                </div>
            </section>
